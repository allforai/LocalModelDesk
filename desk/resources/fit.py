...
def model_fit(entry: ModelEntry, budget: Budget | None, models_root) -> dict:
    ...
    if entry.group == GROUP_CHAT and budget is not None and capacity is not None and models_root is not None:
